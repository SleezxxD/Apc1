...
char caracter;       // caracteres ''
  ...
  float decimal16;   // numero decimal com 6 casas
...
//nao tem string, mas aceita "uma frase"
  ...
  unsigned char caracter_sem_sinal; // i byte 0 a 255 
  ...
  long double duplo_longo; // 16 bytes -1.2E+4932 a 1.2E+4932 (18casas0)
  ...
  unsigned long int inteiro_longo_sem_sinal; // 8 bytes a +15hexa 
